...
class SettingsActivity : AppCompatPreferenceActivity() {
    ...
    override fun onMenuItemSelected(featureId: Int, item: MenuItem) =
            super.onMenuItemSelected(featureId, item) or when (item.itemId) {
                android.R.id.home -> NavUtils.navigateUpFromSameTask(this).let { true }
    ...
    class GeneralPreferenceFragment : PreferenceFragment() {
        ...
        override fun onOptionsItemSelected(item: MenuItem) = when (item.itemId) {
            android.R.id.home -> startActivity(Intent(activity, SettingsActivity::class.java)).let { true }
